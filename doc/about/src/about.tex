...
%\SetEmptyPage
\input ./about/about_quick_start.tex

%\input ./about/about_bluetooth_hc_05_setup.tex

%\SetEmptyPage
\input ./about/about_robo.tex

\input ./about/about_robohand.tex


%\input ./about/tunung_latex.tex
%\input ./about/about_tuning_eskdi.tex
%\input ./about/sample_manual_eskdi.tex
\input ./about/about_qt.tex
